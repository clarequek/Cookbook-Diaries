...
with_node \
  ...
  --target "/Users/admin/Cookbook-Diaries/CookbookDiaries/ios/Pods/Target Support Files/Pods-CookbookDiaries/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-eas-client" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-updates"
